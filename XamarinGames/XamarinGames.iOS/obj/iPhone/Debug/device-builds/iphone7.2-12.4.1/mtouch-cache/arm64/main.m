...
extern void *mono_aot_module_XamarinGames_iOS_info;
...
extern void *mono_aot_module_XamarinGames_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_XamarinGames_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_XamarinGames_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "XamarinGames.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
